...
library TokenApproval {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TokenApproval", _fieldNames);
  }
  ...
  /** Get value */
  function get(bytes32 _tableId, uint256 tokenId) internal view returns (address value) {
  ...
  function get(IStore _store, bytes32 _tableId, uint256 tokenId) internal view returns (address value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256((tokenId)));
  ...
  /** Set value */
  function set(bytes32 _tableId, uint256 tokenId, address value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256((tokenId)));
  ...
  function set(IStore _store, bytes32 _tableId, uint256 tokenId, address value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256((tokenId)));
